...
export const Body = React.createClass({
		render: function () {
			return <div>
					...
					// Need to fix iframe.
					// <Iframe className="iframe" url={"../wowslider.html"} style={"width:800px;height:600px;max-width:100%;overflow:hidden;border:none;padding:0;margin:0 auto;display:block;"} marginHeight="0" marginWidth="0"></Iframe>
